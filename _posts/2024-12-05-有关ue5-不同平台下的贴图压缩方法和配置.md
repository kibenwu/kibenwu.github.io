...
![](/uploads/tc-compressed-formats.png)

**UE中的 ASTC 压缩方式**

ASTC 是主流的移动端压缩方案。 Adaptive Scalable Texture Compression

当平台使用ASTC打包时，UE默认使用 Inter ISPC Texture Compressor 压缩贴图，只支持8x8 及以上的压缩规格。10x10 和 12x 12 则不支持。引擎中也提供了ASTC -Encoder 的压缩方式，可以支持8x8以下的规格，在大规模资源中，ASTC - Encoder 对 Cook 耗时比较高。
...
![](/uploads/tc-astc-block-bpp.png)

**无Alpha 通道， RGB 24位/像素压缩比**

![](/uploads/tc-astc-noalpha-size.png)

一张不带Alpha通道的贴图，压缩ASTC 6x6 , 8x8, 10x10 均无明显失真。而8x8 比 6x6 减小了44.8%, 10x10 则减小了33.7%

**法线贴图**

![](/uploads/tc-astc-normalmap.png)

**推荐结论**

![](/uploads/tc-astc-recommend.png)

**有无Alpha通道对压缩的影响**

在同一压缩格式下，贴图容量不变，带有Alpha通道的贴图压缩质量下降

![](/uploads/tc-astc-alpha-impact.png)
...
![](/uploads/tc-cooker-settings.png)
...
![](/uploads/tc-astc-quality-dropdown.png)
